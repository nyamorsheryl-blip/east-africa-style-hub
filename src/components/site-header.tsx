    ...
    <header className="sticky top-4 z-50 mx-4 md:mx-8">
      <div className="glass mx-auto flex max-w-7xl items-center gap-3 rounded-full px-4 py-2.5 md:gap-6 md:px-6">
        <Link to="/" className="flex items-center gap-2">
          <div className="flex h-9 w-9 items-center justify-center rounded-full text-white font-display font-bold text-lg" style={{ background: "var(--gradient-hero)" }}>M</div>
        ...
        <form
          ...
          className="hidden md:flex flex-1 items-center gap-2 rounded-full bg-white/60 px-4 py-1.5 border border-white/70"
        >
        ...
        <Link to="/wishlist" className="rounded-full p-2 hover:bg-white/60" aria-label="Wishlist">
          <Heart className="h-5 w-5" />
        </Link>

        <Link to="/cart" className="relative rounded-full p-2 hover:bg-white/60" aria-label="Cart">
        ...
        {user ? (
          <DropdownMenu>
            <DropdownMenuTrigger className="rounded-full p-2 hover:bg-white/60"><User className="h-5 w-5" /></DropdownMenuTrigger>
